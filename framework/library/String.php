...
class String {
	 ...
	 */
	public static function substr($string, $start = 0, $length, $charset = self::UTF8, $dot = false) {
	 ...
	 * @return string
	 */
	public static function substr_for_utf8($string, $start, $length = null, $dot = false) {
		$l = strlen ( $string );
		$p = $s = 0;
		if (0 !== $start) {
			while ( $start -- && $p < $l ) {
	 ...
	 * @return string
	 */
	public static function substr_for_gbk($string, $start, $length = null, $dot = false) {
		$l = strlen ( $string );
		$p = $s = 0;
		if (0 !== $start) {
			while ( $start -- && $p < $l ) {
