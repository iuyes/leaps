...
<div class="pad-lr-10">
	<form name="searchform"
		...
		<input type="hidden" value="loginlog" name="controller">
		<input type="hidden" value="search_log" name="action">
		...
		<table width="100%" cellspacing="0" class="search-form">
			<tbody>
				<tr>
					<td>
						<div class="explain-col"><?php echo L('username')?>:<input
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="button" class="button" name="del_log_4"
								value="<?php echo L('removed_data')?>"
								onclick="location='?app=admin&controller=loginlog&action=delete&week=4&menuid=<?php echo $_GET['menuid'];?>'" />
						</div>
					</td>
				</tr>
			</tbody>
