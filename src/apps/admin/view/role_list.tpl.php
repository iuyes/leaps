...
<a
						href="javascript:setting_role(<?php echo $info['roleid']?>, '<?php echo String::addslashes($info['rolename'])?>')"><?php echo L('role_setting');?></a>
						| <a href="javascript:void(0)"
						onclick="setting_cat_priv(<?php echo $info['roleid']?>, '<?php echo String::addslashes($info['rolename'])?>')"><?php echo L('usersandmenus')?></a> |
<?php } else {?>
