...
class Snoopy {
	...
	private $_submit_type = "application/x-www-form-urlencoded"; // default submit
	                                                         // type
	private $_mime_boundary = ""; // MIME boundary for multipart/form-data submit
	                            // type
	...
	/*
	 * ======================================================================*\
	 * Function:	fetch Purpose:	fetch the contents of a web page (and possibly
	 * other protocols in the future like ftp, nntp, gopher, etc.)
				...
				if ($this->_connect ( $fp )) {
					...
					if ($this->_redirectaddr) {
						...
						if ($this->maxredirs > $this->_redirectdepth) {
							// only follow redirect if it's on this site, or
							// offsiteok is true
	...
	/*
	 * ======================================================================*\
	 * Function:	submit Purpose:	submit an http form Input:		$URI	the location
	 * to post the data $formvars	the formvars to use. format: $formvars["var"]
	 * = "val"; $formfiles an array of files to submit format: $formfiles["var"]
	 * = "/dir/filename.ext"; Output:		$this->results	the text output from the
	 * post
	 * \*======================================================================
	 */
						...
						if ($this->maxredirs > $this->_redirectdepth) {
							...
							if (preg_match ( "|^http://" . preg_quote ( $this->host ) . "|i", $this->_redirectaddr ) || $this->offsiteok) {
								...
								if (strpos ( $this->_redirectaddr, "?" ) > 0)
									$this->fetch ( $this->_redirectaddr ); // the redirect
									                                    // has changed the request method
									                                    // from post to get
								else
	...
	/*
	 * ======================================================================*\
	 * Function:	fetchlinks Purpose:	fetch the links from a web page
	 * Input:		$URI	where you are fetching from Output:		$this->results	an array
	 * of the URLs
	 * \*======================================================================
	 */
	...
	/*
	 * ======================================================================*\
	 * Function:	fetchform Purpose:	fetch the form elements from a web page
	 * Input:		$URI	where you are fetching from Output:		$this->results	the
	 * resulting html form
	 * \*======================================================================
	 */
	...
	/*
	 * ======================================================================*\
	 * Function:	fetchtext Purpose:	fetch the text from a web page, stripping
	 * the links Input:		$URI	where you are fetching from
	...
	/*
	 * ======================================================================*\
	 * Function:	submitlinks Purpose:	grab links from a form submission
	 * Input:		$URI	where you are submitting from Output:		$this->results	an
	 * array of the links from the post
	 * \*======================================================================
	 */
	...
	/*
	 * ======================================================================*\
	 * Function:	submittext Purpose:	grab text from a form submission
	 * Input:		$URI	where you are submitting from Output:		$this->results	the
	...
	/*
	 * ======================================================================*\
	 * Function:	set_submit_multipart Purpose:	Set the form submission content
	...
	/*
	 * ======================================================================*\
	 * Function:	set_submit_normal Purpose:	Set the form submission content type
...
\*======================================================================*/
	 ...
	 * document Input:		$document	document to strip. Output:		$match		an array
	 * of the links
	 * \*======================================================================
	 */
	...
	/*
	 * ======================================================================*\
	 * Function:	_striptext Purpose:	strip the text from an html document
	 * Input:		$document	document to strip. Output:		$text		the resulting text
	 * \*======================================================================
	 */
	...
	/*
	 * ======================================================================*\
	 * Function:	_expandlinks Purpose:	expand each link into a fully qualified
	 * URL Input:		$links			the links to qualify $URI			the full URI to get the
	 * base from Output:		$expandedLinks	the expanded links
	 * \*======================================================================
	 */
	...
	/*
	 * ======================================================================*\
	 * Function:	_httprequest Purpose:	go get the http data from the server
	 * Input:		$url		the url to fetch $fp			the current open file pointer
	 * $URI		the full URI $body		body contents to send if any (POST) Output:
	 * \*======================================================================
	 */
	...
	/*
	 * ======================================================================*\
	 * Function:	_httpsrequest Purpose:	go get the https data from the server
	 * using curl Input:		$url		the url to fetch $URI		the full URI $body		body
	 * contents to send if any (POST) Output:
	 * \*======================================================================
	 */
	public function _httpsrequest($url, $URI, $http_method, $content_type = "", $body = "") {
		...
		// $headers[] = $http_method." ".$url." ".$this->_httpversion;
		if (! empty ( $this->agent )) $headers [] = "User-Agent: " . $this->agent;
		if (! empty ( $this->host )) if (! empty ( $this->port ))
	...
	/*
	 * ======================================================================*\
	 * Function:	_check_timeout Purpose:	checks whether timeout has occurred
	...
	/*
	 * ======================================================================*\
	 * Function:	_connect Purpose:	make a socket connection Input:		$fp	file
	 * pointer
	 * \*======================================================================
	 */
	...
	/*
	 * ======================================================================*\
	 * Function:	_disconnect Purpose:	disconnect a socket connection
	 * Input:		$fp	file pointer
	 * \*======================================================================
	 */
	...
	/*
	 * ======================================================================*\
	 * Function:	_prepare_post_body Purpose:	Prepare post body according to
	 * encoding type Input:		$formvars - form variables $formfiles - form upload
	 * files Output:		post body
	 * \*======================================================================
	 */
