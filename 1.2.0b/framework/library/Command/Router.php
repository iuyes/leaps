...
class Command_Router {
	...
	public function match() {
		$_pathinfo = Command_Request::parse_cli_args ();
	...
	protected function set_params() {
		$this->action = Command_Request::get_request ( 'action' ) ? Command_Request::get_request ( 'action' ) : $this->_config ['action'];
		$this->controller = Command_Request::get_request ( 'controller' ) ? Command_Request::get_request ( 'controller' ) : $this->_config ['controller'];
	}
