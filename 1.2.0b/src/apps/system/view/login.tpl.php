...
<style type="text/css">
html {}
body {color: #fff;font-size: 14px;padding: 0;overflow: hidden;margin: 0;width: 100%;height: 100%;min-height: 400px;background: #2784bd url(<?php echo SITE_URL;?>admin/images/bg_line.gif) repeat-x left top;}
#topbg {z-index: -1;position: absolute;left: 0;width: 100%;height: 360px;background: url(<?php echo SITE_URL;?>admin/images/bg.jpg) no-repeat center top;}
...
.input {font-size: 22px;padding-left: 12px;padding-right: 0px;width: 234px;height: 30px;background: url(<?php echo SITE_URL; ?>admin/images/login_spacer.gif);color: #383838;outline: medium none;border: none;}
.input_div {position: absolute;margin-top: 14px;width: 295px;height: 80px;background: url(<?php echo SITE_URL;?>admin/images/login_input_bg.png) 0 10px;}
...
.submit_bg {background: url(<?php echo SITE_URL;?>admin/images/login_submit.png);width: 80px;height: 42px;position: absolute;overflow: hidden;margin-top: 34px;}
...
.input_bg_forie6 .inputbg{position:absolute;top:10px;width:286px;height:80px;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='<?php echo SITE_URL;?>admin/images/login_input_bg.png');}
.submit_bg_forie6{position:absolute;width:80px;height:42px;overflow:hidden;}
.submit_bg_forie6 .inputbg{position:absolute;width:80px;height:42px;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='<?php echo SITE_URL ;?>admin/images/login_submit.png');}
</style>
<![endif]-->
...
<div id="body">
  ...
  <table border="0" align="center" height="100%" width="500">
    ...
    <tr>
      <td height="200" align="left" valign="top"><div style="position: absolute; text-align: left; width: 400px; height: 190px; margin-left: 90px; background: url(<?php echo SITE_URL;?>admin/images/admin.png) no-repeat left top; _background: none; _filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='<?php echo IMG_PATH. 'admin_img/admin.png';?>' );">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="30"
              ...
              <tr>
                <td align="left" valign="bottom"><img id="image1"
										...
										src="<?php echo SITE_URL;?>admin/images/admin_p2.png" /></td>
              </tr>
            </table>
          </div>
            ...
            <table style="width: 60px; height: 50px;" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" valign="bottom"><img id="image2"
										...
										src="<?php echo SITE_URL;?>admin/images/admin_p1.png" /></td>
              </tr>
            </table>
          </div>
          <div style="position: absolute; width: 400px; height: 190px; background: url(<?php echo SITE_URL;?>admin/images/login_spacer.gif);"></div>
        </div>
        <script type="text/javascript">
(function(){
	...
	if (is_ie && ie<7){
		...
		var src1 = obj1.src;
		var src2 = obj2.src;
		obj1.src = obj2.src = '<?php echo SITE_URL;?>admin/images/login_spacer.gif';
...
if (Detector.webgl){
    ...
    if ( !disabled_cloud ){
        ...
        var img = new Image('<?php echo SITE_URL;?>admin/images/cloud10.png');
        setTimeout('img=null;',2000);
    document.write('<script type="text/javascript" src="<?php echo SITE_URL;?>admin/js/ThreeWebGL.js"></'+'script><script type="text/javascript" src="<?php echo SITE_URL;?>admin/js/ThreeExtras.js"></'+'script>');
}else{
...
function init() {
    ...
    var texture = THREE.ImageUtils.loadTexture('<?php echo SITE_URL. 'admin/images/cloud10.png';?>');
